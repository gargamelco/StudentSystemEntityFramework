namespace SSEF.DbContext.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            if (!(context.Users.Any(u => u.Email == "dinkov.com@gmail.com")))
            {
                var userStore = new UserStore<ApplicationUser>(context);
                var userManager = new UserManager<ApplicationUser>(userStore);
                var userToInsert = new ApplicationUser { UserName = "dinkov.com@gmail.com", PhoneNumber = "0899119158" , Email = "dinkov.com@gmail.com" };
            ...
            if (!(context.Users.Any(u => u.Email == "student1@gmail.com")))
            {
                var userStore = new UserStore<ApplicationUser>(context);
                var userManager = new UserManager<ApplicationUser>(userStore);
                var userToInsert = new ApplicationUser { UserName = "student1@gmail.com", PhoneNumber = "0797697898" , Email = "student1@gmail.com" };
            ...
            if (!(context.Users.Any(u => u.Email == "student3@gmail.com")))
            {
                var userStore = new UserStore<ApplicationUser>(context);
                var userManager = new UserManager<ApplicationUser>(userStore);
                var userToInsert = new ApplicationUser { UserName = "student3@gmail.com", PhoneNumber = "0797697898", Email = "student3@gmail.com" };
                userManager.Create(userToInsert, "password123");
            }
